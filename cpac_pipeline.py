...
def prep_workflow(sub_dict, c, strategies, run, pipeline_timing_info=None,
    ...
    if 1 in c.runEPI_DistCorr:
       ...
       for strat in strat_list:
            ...
            epi_distcorr.inputs_SkullStripping_method.SkullStripping_method = c.SkullStripping_method_EPI_DistCorr
            epi_distcorr.get_node('SkullStripping_method').iterables = ('SkullStripping_method',c.SkullStripping_method_EPI_DistCorr)
