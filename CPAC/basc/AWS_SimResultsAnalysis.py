...
data_dir='/home/ec2-user/PyBASC_outputs'
GS=[1,10,30,60,100]
SNR=['0.05corr_2noise', '0.3corr_3noise','0.3corr_2noise']
Volumes=[100,200,400]

TrueClust=nb.load('/home/ec2-user/git_repo/PyBASC/masks/TrueBGClust.nii.gz').get_data().astype('float32').astype('bool')
roi_mask_file='/home/ec2-user/git_repo/PyBASC/masks/BG_3mm_TrueClust.nii.gz'
