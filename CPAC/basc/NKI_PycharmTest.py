...
print((time.time() - GroupAnalysisStart))
    #return {'G': G, 'clusters_G': clusters_G, 'cluster_voxel_scores': cluster_voxel_scores, 'gsm_file': gsm_file,
    #        'clusters_G_file': clusters_G_file, 'cluster_voxel_scores_file': cluster_voxel_scores_file}
