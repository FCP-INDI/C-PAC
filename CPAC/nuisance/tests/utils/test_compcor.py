...
def test_TR_string_to_float():
    assert abs(compcor.TR_string_to_float("123") - 123.0) < 1e-08
    assert abs(compcor.TR_string_to_float("123s") - 123.0) < 1e-08
    assert abs(compcor.TR_string_to_float("123ms") - 123.0 / 1000) < 1e-08
