...
def configuration_strategy_mock( method = 'FSL' ):
    ...
    resource_dict = {
            "functional_nuisance_residuals": os.path.join(c.outputDirectory,
            ...
            "functional_brain_mask": os.path.join(c.outputDirectory,
                "functional_brain_mask/_scan_test/sub-M10978008_ses-NFB3_task-test_bold_calc_tshift_resample_volreg_mask.nii.gz"),
