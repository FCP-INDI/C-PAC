...
from nipype.interfaces.afni.preprocess import ECM as _ECM, ECMInputSpec as _ECMInputSpec
...
class ECMInputSpec(_ECMInputSpec):
    ...
    do_binary = traits.Bool(
        desc="whether to perform the ECM calculation on a "
