...
def run_surface(
    ...
    cmd = [
        "bash",
        "/code/CPAC/surface/PostFreeSurfer/block1.sh",
        post_freesurfer_folder,
        freesurfer_folder,
        subject,
        t1w_restore_image,
    ...
    cmd = [
        "bash",
        "/code/CPAC/surface/PostFreeSurfer/block2.sh",
        post_freesurfer_folder,
        freesurfer_folder,
        subject,
        t1w_restore_image,
    ...
    cmd = [
        "bash",
        "/code/CPAC/surface/PostFreeSurfer/block3.sh",
        post_freesurfer_folder,
        freesurfer_folder,
        subject,
        t1w_restore_image,
    ...
    cmd = [
        "bash",
        "/code/CPAC/surface/PostFreeSurfer/block4.sh",
        post_freesurfer_folder,
        freesurfer_folder,
        subject,
        t1w_restore_image,
    ...
    cmd = [
        "bash",
        "/code/CPAC/surface/PostFreeSurfer/block5.sh",
        post_freesurfer_folder,
        freesurfer_folder,
        subject,
        t1w_restore_image,
    ...
    cmd = [
        "bash",
        "/code/CPAC/surface/PostFreeSurfer/block6.sh",
        post_freesurfer_folder,
        freesurfer_folder,
        subject,
        t1w_restore_image,
    ...
    cmd = [
        "bash",
        "/code/CPAC/surface/PostFreeSurfer/block7.sh",
        post_freesurfer_folder,
        freesurfer_folder,
        subject,
        t1w_restore_image,
    ...
    subcortical_atlas = os.path.join(
        post_freesurfer_folder,
        "MNINonLinear/Results/task-rest01/task-rest01_AtlasSubcortical_s2.nii.gz",
    )

    good_voxels = os.path.join(
        post_freesurfer_folder,
        "MNINonLinear/Results/task-rest01/RibbonVolumeToSurfaceMapping/"
        "goodvoxels.nii.gz",
    )

    ribbon_only = os.path.join(
        post_freesurfer_folder,
        "MNINonLinear/Results/task-rest01/RibbonVolumeToSurfaceMapping/"
        "ribbon_only.nii.gz",
    )
    ...
    spec = {
        ...
        "native": os.path.join(
            post_freesurfer_folder, "MNINonLinear/Native/", f"{subject}.native.wb.spec"
        ),
    }
    ...
    return (
        dtseries,
        aparc["desikan_killiany"][164],
        aparc["destrieux"][164],
        aparc["desikan_killiany"][32],
        aparc["destrieux"][32],
        subcortical_atlas,
        good_voxels,
        ribbon_only,
        ...
        spec["LR_32k"],
        spec["native"],
        areal_distortion["FS"]["L"],
        areal_distortion["FS"]["R"],
        areal_distortion["FS"]["dscalar"],
        areal_distortion["MSMSulc"]["L"],
        areal_distortion["MSMSulc"]["R"],
        areal_distortion["MSMSulc"]["dscalar"],
        edge_distortion["FS"]["L"],
        edge_distortion["FS"]["R"],
        edge_distortion["FS"]["dscalar"],
        edge_distortion["MSMSulc"]["L"],
        edge_distortion["MSMSulc"]["R"],
        edge_distortion["MSMSulc"]["dscalar"],
        curvature["L"],
        curvature["R"],
        curvature["dscalar"],
        flat["L"],
        flat["R"],
        inflate_32k["inflated"]["L"],
        inflate_32k["inflated"]["R"],
        inflate_32k["very_inflated"]["L"],
        inflate_32k["very_inflated"]["R"],
        inflate["inflated"]["L"],
        inflate["inflated"]["R"],
        inflate["very_inflated"]["L"],
        inflate["very_inflated"]["R"],
        midthickness["L"][164],
        midthickness["L"][32],
        midthickness["L"]["native"],
        midthickness["R"][164],
        midthickness["R"][32],
        midthickness["R"]["native"],
        pial["L"][32],
        pial["L"]["native"],
        pial["R"][32],
        pial["R"]["native"],
        ...
        StrainJ["MSMSulc"]["L"],
        StrainJ["MSMSulc"]["R"],
        StrainJ["MSMSulc"]["dscalar"],
        StrainR["FS"]["L"],
        StrainR["FS"]["R"],
        StrainR["FS"]["dscalar"],
        StrainR["MSMSulc"]["L"],
        StrainR["MSMSulc"]["R"],
        StrainR["MSMSulc"]["dscalar"],
        sulc["L"],
        sulc["R"],
        sulc["dscalar"],
        thickness["L"],
...
def surface_postproc(wf, cfg, strat_pool, pipe_num, opt=None):
    ...
    surf.inputs.subcortical_gray_labels = cfg.surface_analysis["post_freesurfer"][
        "subcortical_gray_labels"
    ]
    ...
    surf.inputs.gray_ordinates_res = str(
        cfg.surface_analysis["post_freesurfer"]["gray_ordinates_res"]
    )
    surf.inputs.high_res_mesh = str(
        cfg.surface_analysis["post_freesurfer"]["high_res_mesh"]
    )
    surf.inputs.low_res_mesh = str(
        cfg.surface_analysis["post_freesurfer"]["low_res_mesh"]
    )
    surf.inputs.fmri_res = str(cfg.surface_analysis["post_freesurfer"]["fmri_res"])
    surf.inputs.smooth_fwhm = str(
        cfg.surface_analysis["post_freesurfer"]["smooth_fwhm"]
    )
    ...
    outputs = {
        ...
        "atlas-DesikanKilliany_space-fsLR_den-32k": (surf, "desikan_killiany_32"),
        "atlas-Destrieux_space-fsLR_den-32k": (surf, "destrieux_32"),
        "atlas-DesikanKilliany_space-fsLR_den-164k": (surf, "desikan_killiany_164"),
        ...
        "hemi-L_space-fsLR_den-32k_desc-atlasroi_bold": (surf, "atlas_roi_func_L"),
        "hemi-R_space-fsLR_den-32k_desc-atlasroi_bold": (surf, "atlas_roi_func_R"),
        "hemi-L_space-fsLR_den-32k_desc-atlasroi_mask": (surf, "atlas_roi_shape_L"),
        "hemi-R_space-fsLR_den-32k_desc-atlasroi_mask": (surf, "atlas_roi_shape_R"),
        "hemi-L_space-native_bold": (surf, "native_L"),
        "hemi-R_space-native_bold": (surf, "native_R"),
        "space-fsLR_den-32k_wb-spec": (surf, "spec_LR_32k"),
        "space-native_wb-spec": (surf, "spec_native"),
        "hemi-L_space-fsLR_den-32k_desc-FS_arealdistortion": (
            surf,
            "areal_distortion_FS_L",
        ),
        ...
        "hemi-L_space-fsLR_den-32k_curv": (surf, "curvature_L"),
        "hemi-R_space-fsLR_den-32k_curv": (surf, "curvature_R"),
        "space-fsLR_den-32k_curv": (surf, "curvature_dscalar"),
...
def surface_falff(wf, cfg, strat_pool, pipe_num, opt):
    ...
    outputs = {"space-fsLR_den-32k_bold_surf_falff": (falff, "surf_falff")}
    return wf, outputs
...
def surface_alff(wf, cfg, strat_pool, pipe_num, opt):
    ...
    outputs = {"space-fsLR_den-32k_bold_surf_alff": (alff, "surf_alff")}
    return wf, outputs
...
def surface_connectivity_matrix(wf, cfg, strat_pool, pipe_num, opt):
    ...
    connectivity_parcellation.inputs.surf_atlaslabel = cfg.surface_analysis[
    ...
    wf.connect(
        connectivity_parcellation, "parcellation_file", correlation_matrix, "ptseries"
    )
...
def run_ciftiparcellate(subject, dtseries, surf_atlaslabel):
    ...
    parcellation_file = os.path.join(
        os.getcwd(), f"{subject}_parcellation.ptseries.nii"
    )
    cmd = [
        "wb_command",
        "-cifti-parcellate",
