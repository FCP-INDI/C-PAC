...
def load_config_yml(config_file, individual=False):
    ...
    try:
        ...
        config_dict = yaml.safe(open(config_path, 'r'), Loader=yamlordereddictloader.Loader)
...
def run_cwas(pipeline_config):
    ...
    pipeconfig_dct = yaml.load(open(pipeline_config, 'r'), Loader=yamlordereddictloader.Loader)
