...
def create_3dskullstrip_arg_string(shrink_fac, var_shrink_fac,
    ...
    expr = '-shrink_fac {0}' '{1}' '-shrink_fac_bot_lim {2}' 'avoid_vent{3}' '-niter {4}' '{5}'  '{6}' '-fill_hole {7}' '{8}' '{9}' '-exp_frac {10}' '-smooth_final {11}' '{12}' '{13}' '-perc_int{14}' '-max_inter_iter{15}' '-blur_fwhm{16}' \
