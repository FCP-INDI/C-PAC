...
def abcd_reconall(T1wImage, T1wImageFile, T1wImageBrainFile, SubjectID, SubjectDIR, openmp):
    ...
    gca_path = '$FREESURFER_HOME/average/RB_all_2008-03-26.gca' # RB_all_2020-01-02.gca
    ...
    gca_withskull_path = '$FREESURFER_HOME/average/RB_all_withskull_2008-03-26.gca' # RB_all_withskull_2020_01_02.gca
...
def create_anat_preproc(method='afni', already_skullstripped=False,
    ...
    if already_skullstripped:
        ...
        if method == 'freesurfer':
            ...
            ### ABCD recon-all ###
            reconall = pe.Node(util.Function(input_names=['T1wImage',
                                                          'T1wImageFile',
                                                          'T1wImageBrainFile',
                                                          'SubjectID',
                                                          'SubjectDIR',
