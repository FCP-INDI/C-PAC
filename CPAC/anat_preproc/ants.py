...
04-modality-specific-files/01-magnetic-resonance-imaging-data.html#anatomy-imaging-data
    ...
    **Outputs**
    ...
    copy_xform = pe.Node(
        ...
        mem_gb=1.3,
        mem_x=(3811976743057169 / 302231454903657293676544, "hdr_file"),
    )
    ...
    map_brainmask = pe.Node(
        ApplyTransforms(interpolation="Gaussian", float=True), name="map_brainmask"
    )
    ...
    wf.connect(
        [
            ...
            (
                inu_n4_final,
                copy_xform,
                [("output_image", "bias_corrected"), ("bias_image", "bias_image")],
            ),
            (
                copy_xform,
                outputnode,
    ...
    if atropos_refine:
        ...
        sel_wm = pe.Node(
            ...
            run_without_submitting=True,
            mem_gb=0.1,
            mem_x=(5157380299430287 / 302231454903657293676544, "inlist"),
        )
...
def init_atropos_wf(
    ...
    **Outputs**
    ...
    fill_gm = pe.Node(
        ImageMath(operation="FillHoles", op2="2"),
        name="07_fill_gm",
        mem_gb=2.1,
        mem_x=(1435097126797993 / 1208925819614629174706176, "op1"),
    )
    mult_gm = pe.Node(
    ...
    wf.connect(
        [
            ...
            (
                inputnode,
                atropos,
                [("in_files", "intensity_images"), ("in_mask_dilated", "mask_image")],
            ),
