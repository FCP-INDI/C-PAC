...
def warp_cleaned_timeseries_to_T1template_abcd(wf, cfg, strat_pool, pipe_num, opt=None):
    """
    {"name": "transform_cleaned_timeseries_to_T1template_abcd",
     "config": "None",
    ...
    outputs = {
        'space-template_desc-cleaned_bold': (extract_func_brain, 'out_file')
    }
...
def single_step_resample_cleaned_timeseries_to_T1template(wf, cfg, strat_pool, pipe_num, opt=None):
    """
    {"name": "single_step_resample_cleaned_timeseries_to_T1template",
     "config": "None",
     "switch": [["registration_workflows", "functional_registration",
                 "func_registration_to_template", "run"],
                ["nuisance_corrections", "2-nuisance_regression", "create_regressors"],
    ...
    outputs = {
        'space-template_desc-cleaned_bold': (apply_mask, 'out_file')
    }
