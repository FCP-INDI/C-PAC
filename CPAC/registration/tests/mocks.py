...
def configuration_strategy_mock(method="FSL"):
    ...
    resource_dict = {
        ...
        "ants_affine_xfm": os.path.join(
            c.outputDirectory, "ants_affine_xfm/transform2Affine.mat"
        ),
        "ants_rigid_xfm": os.path.join(
            c.outputDirectory, "ants_rigid_xfm/transform1Rigid.mat"
        ),
        ...
        "ants_symm_affine_xfm": os.path.join(
            c.outputDirectory, "ants_symmetric_affine_xfm/transform2Affine.mat"
        ),
        "ants_symm_rigid_xfm": os.path.join(
            c.outputDirectory, "ants_symmetric_rigid_xfm/transform1Rigid.mat"
        ),
    ...
    if method == "ANTS":
        resource_dict["anatomical_to_mni_nonlinear_xfm"] = os.path.join(
            c.outputDirectory, "anatomical_to_mni_nonlinear_xfm/transform3Warp.nii.gz"
        )
    else:
        resource_dict["anatomical_to_mni_nonlinear_xfm"] = os.path.join(
            c.outputDirectory,
