...
def anat_brain_to_bold_res(wf_name, cfg, pipe_num):
    ...
    inputNode = pe.Node(util.IdentityInterface(fields=['T1w-template-funcreg',
                                                        'space-template_desc-preproc_T1w']),
                        name='inputspec')
    outputNode = pe.Node(util.IdentityInterface(fields=['space-template_res-bold_desc-brain_T1w']),
                            name='outputspec')
    ...
    wf.connect(inputNode, 'space-template_desc-preproc_T1w', anat_brain_to_func_res, 'in_file')
    wf.connect(inputNode, 'T1w-template-funcreg', anat_brain_to_func_res, 'ref_file')

    wf.connect(anat_brain_to_func_res, 'out_file', outputNode, 'space-template_res-bold_desc-brain_T1w')
    return wf
...
def anat_brain_mask_to_bold_res(wf_name, cfg, pipe_num):
    ...
    wf = pe.Workflow(name=f"{wf_name}_{pipe_num}")
    inputNode = pe.Node(util.IdentityInterface(fields=['space-template_desc-T1w_mask',
                                                        'space-template_desc-preproc_T1w']),
                        name='inputspec')
    outputNode = pe.Node(util.IdentityInterface(fields=['space-template_desc-bold_mask']),
                            name='outputspec')
    ...
    wf.connect(inputNode, 'space-template_desc-T1w_mask', anat_brain_mask_to_func_res, 'in_file')
    wf.connect(inputNode, 'space-template_desc-preproc_T1w', anat_brain_mask_to_func_res, 'ref_file')
    wf.connect(anat_brain_mask_to_func_res, 'out_file', outputNode, 'space-template_desc-bold_mask')
...
def bold_mask_anatomical_resampled(wf, cfg, strat_pool, pipe_num, opt=None):
    ...
    wf.connect(node, out, anat_brain_to_func_res, 'inputspec.space-template_desc-preproc_T1w')
    ...
    wf.connect(anat_brain_to_func_res, 'outputspec.space-template_res-bold_desc-brain_T1w',
               anat_brain_mask_to_func_res, 'inputspec.space-template_desc-preproc_T1w')
    ...
    wf.connect(anat_brain_mask_to_func_res, 'outputspec.space-template_desc-bold_mask',
    ...
    outputs = {
        'space-template_res-bold_desc-brain_T1w': (anat_brain_to_func_res, 'outputspec.space-template_res-bold_desc-brain_T1w'),
        'space-template_desc-bold_mask': (anat_brain_mask_to_func_res, 'outputspec.space-template_desc-bold_mask'),
