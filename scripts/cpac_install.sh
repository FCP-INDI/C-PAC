...
then
    ...
    git clone -b 0.9.2_cpac https://github.com/fcp-indi/nipype.git
    cd nipype
...
wget http://fcon_1000.projects.nitrc.org/indi/cpac_image_resources.zip
unzip cpac_image_resources.zip
cd cpac_image_resources
cd ./symmetric
# --- Move the templates to the FSL directory ---
cp -v MNI152_T1_2mm_brain_mask_symmetric_dil.nii.gz $FSLDIR/data/standard
cp -v MNI152_T1_2mm_brain_symmetric.nii.gz $FSLDIR/data/standard
cp -v MNI152_T1_2mm_symmetric.nii.gz $FSLDIR/data/standard
cp -v MNI152_T1_3mm_brain_mask_symmetric_dil.nii.gz $FSLDIR/data/standard
cp -v MNI152_T1_3mm_brain_symmetric.nii.gz $FSLDIR/data/standard
cp -v MNI152_T1_3mm_symmetric.nii.gz $FSLDIR/data/standard
cp -v T1_2_MNI152_2mm_symmetric.cnf $FSLDIR/data/standard
cd ./../tissuepriors
cp -R -v 2mm $FSLDIR/data/standard/tissuepriors
cp -R -v 3mm $FSLDIR/data/standard/tissuepriors
#
##### Install CPAC #####
